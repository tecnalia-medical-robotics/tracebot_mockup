...
def command_pub():
	...
	while not rospy.is_shutdown():
		...
		tracebot.joint_names = ['left_shoulder_pan_joint', 'left_shoulder_lift_joint', 'left_elbow_joint', 'left_wrist_1_joint', 'left_wrist_2_joint', 'left_wrist_3_joint']
		tracebot.header.stamp = rospy.Time.now()
		
		point.positions = [1.5,1.5,1.5,1.5,1.5,1.5]
